...
const style = {
  ...
  tweetButton: `text-white  flex flex-col bg-twitter hover:bg-twitterDark items-center justify-center font-bold rounded-3xl h-[50px] mt-[20px] cursor-pointer sm:ml-0 mr-4 lg-w-full`,
      ...
      >
        ...
        <div className={style.profileRight}>
          <div className={style.details}>
            ...
            <div className={style.handle}>@{currentUser.username}</div>
          </div>
