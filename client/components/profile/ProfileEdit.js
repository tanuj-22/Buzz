...
const style = {
  ...
  header: `flex justify-between items-center text-2xl font-bold mb-4`,
...
const ProfileEdit = () => {
  ...
  const { currentUser, updateProfile } = useContext(TwitterContext);
  ...
  return (
    <div className={style.wrapper}>
      ...
      <div className={style.inputFieldsContainer}>
        ...
        <div className={style.inputContainer}>
          <label htmlFor="website">Wallet</label>
          <input
            type="text"
            name="wallet"
            id="wallet"
